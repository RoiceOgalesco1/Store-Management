...
$total_count = count_by_id('companies')['total'];

// Get paginated companies
$all_companies = find_paginated_companies($per_page, $offset);
                        ...
                        <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md" @click.away="showAddCategory = false">
                            ...
                            <form method="post" action="categorie.php">
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="brandName" name="brand-name" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>
                                <div class="flex justify-end space-x-3">
                                    ...
                                    <button type="submit" name="add_brand" class="px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700">
                                        Save Brand
                                    </button>
                                </div>
                            </form>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="whitespace-nowrap text-sm">
                                    <td class="px-6 py-4 font-medium text-gray-900"><?php echo (int)$com['id'];?></td>
                                    <td class="px-6 py-4 text-gray-500"><?php echo remove_junk(ucfirst($com['bname'])); ?></td>
                                    <td class="px-6 py-4 text-gray-500">
                                        <div class="flex space-x-3 text-sm">
                                            <a href="./edit_company.php?id=<?php echo (int)$com['id'];?>" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                                            <a href="./delete_company.php?id=<?php echo (int)$com['id'];?>" class="text-red-600 hover:text-red-900">Delete</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
